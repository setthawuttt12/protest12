    ...
    <v-container>
        <v-row justify="center">
            <v-col cols="12" md="12">
                <v-card color="#404040">
                    <v-card-title>
                        <h1 class="text-h5 text-center">แก้ไข้ข้อมูลส่วนตัว</h1>
                    </v-card-title>
                    <v-card-text class="bg-white">
                        ...
                        <v-form @submit.prevent="saveMember">
                            <v-row>
                                <v-col cols="12" md="6">
                                    <v-text-field label="ชื่อ" v-model="form.fname" :error-messages="error.fname"
                                        prepend-inner-icon="mdi-alpha-f"></v-text-field>
                                </v-col>
                                <v-col cols="12" md="6">
                                    <v-text-field label="นามสกุล" v-model="form.lname" :error-messages="error.lname"
                                        prepend-inner-icon="mdi-alpha-l"></v-text-field>
                                </v-col>
                                <v-col cols="12" md="6">
                                    <v-text-field label="อีเมล" v-model="form.email" :error-messages="error.email"
                                ...
                                <v-col cols="12" md="6">
                                    <v-text-field label="รหัสผ่าน" v-model="form.password"
                                        ...
                                        @click:prepend-inner="show = !show, showPw = !showPw"></v-text-field>
                                </v-col>
                                <v-col cols="12" md="6">
                                    <v-text-field label="ยืนยันรหัสผ่าน" v-model="conP" :error-messages="error.conP"
                                        :prepend-inner-icon="show2 ? 'mdi-eye' : 'mdi-eye-off'"
                                        :type="showPw2 ? 'text' : 'password'"
                                        @click:prepend-inner="show2 = !show2, showPw2 = !showPw2"></v-text-field>
                                </v-col>
                                <v-col cols="12" md="12">
                            ...
                            <v-row>
                                <v-col cols="12" md="12">
                                    <center>
                                        <v-btn class="text-center ma-3" color="primary" type="submit">แก้ไข</v-btn>
