                    ...
                    <v-card-text class="bg-white">
                        ...
                        <v-form @submit.prevent="saveMember">
                            ...
                            <v-row>
                                <v-col cols="12" md="12">
                                    <center>
                                        <v-btn class="text-center ma-3" color="primary" type="submit">สมัครสมาชิก</v-btn>
                                        <v-btn class="text-center ma-3" color="error" type="reset">ยกเลิก</v-btn>
                                    </center>
                                </v-col>
                            </v-row>
                        </v-form>
                        <nuxt-link to="/" class="text-blue text-center text-decoration-none"><p>หากมีบัญชีอยู่แล้ว? เข้าสู่ระบบ</p></nuxt-link>
                    </v-card-text>
                </v-card>
            </v-col>
        </v-row>
