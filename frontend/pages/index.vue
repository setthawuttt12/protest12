    ...
    <v-container>
        <v-row justify="center">
            <v-col cols="12" md="8">
                <v-card color="#7d0c14">
                    <v-card-title>
                        <center><v-img src="/img/logo.png" width="25%" class="mt-3"></v-img></center>
                        <h1 class="text-h5 text-center">NTC EVALUATION SYSTEM</h1>
                    ...
                    <v-card-text class="bg-white">
                        ...
                        <v-form @submit.prevent="Login">
                            <v-row>
                                ...
                                <v-col cols="12" md="12">
                                    <v-select label="ประเภทสมาชิก" v-model="role"  :items="typeR" prepend-inner-icon="mdi-account-group"></v-select>
                                </v-col>
                            ...
                            <v-row>
                                <v-col cols="12" md="12">
                                    <center>
                                        <v-btn class="text-center ma-3" color="primary" type="submit">เข้าสู่ระบบ</v-btn>
                                        <v-btn class="text-center ma-3" color="error" type="reset">ยกเลิก</v-btn>
                                    </center>
                                </v-col>
                            </v-row>
                        </v-form>
                        <nuxt-link to="/regis" class="text-blue text-center text-decoration-none"><p>หากไม่มีบัญชีอยู่? สมัครสมาชิก</p></nuxt-link>
                    </v-card-text>
                </v-card>
            </v-col>
        </v-row>
